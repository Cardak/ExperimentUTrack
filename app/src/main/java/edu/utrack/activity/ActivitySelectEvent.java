...
public class ActivitySelectEvent extends TrackActivity implements ReloadingActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(tutorial) {
            if (getSettings().tutorial) {
                System.out.println("Would draw tutorial here!");
    ...
    public void getMenuItems(Map<Integer, Runnable> menus) {
       ...
       if(tutorial) menus.put(R.id.menuTutorial, this::showTutorial);
    ...
    private void updateEvents(List<CalendarEvent> events) {
        ...
        CalendarData testCalendar = new CalendarData(-1, "Kieron@gmail.com", "Kieron", "Kieron");
        CalendarEvent testEvent = new CalendarEvent(testCalendar, -1, "Experiment", "University of Bath", cal.getTimeInMillis(), System.currentTimeMillis());
        events.add(0, testEvent);
